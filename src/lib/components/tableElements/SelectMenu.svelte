...
<div class="paddingWrapper">
    <div class="wrapper">
        <select type="{inputType}" on:input="{handleInput}" on:change={handleInput} name="{inputKey}" id="{inputKey}" value={inputValue} {...additionalAttributes} class="border-bottom-{hoverColor}" placeholder=" "/>
